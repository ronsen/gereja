...
<body class="d-flex h-100 text-bg-dark text-center">
	...
	<div class="dropdown position-fixed bd-mode-toggle bottom-0 end-0 mb-3 me-3">
		<button class="btn btn-bd-primary dropdown-toggle d-flex align-items-center py-2" id="bd-theme" type="button"
	...
	<div class="cover-container d-flex w-100 h-100 flex-column mx-auto p-3">
		...
		<footer class="text-white-50 mt-auto">
			<p>Untuk informasi lebih lanjut, silakan hubungi <strong><a href="https://s.id/ronsen">Ronald Nababan</a></strong>
				di <a href="mailto:ronsen@startrek.or.id">ronsen@startrek.or.id</a>
				atau via <a href="https://wa.me/6281319479396">WhatsApp</a></p>
		</footer>
